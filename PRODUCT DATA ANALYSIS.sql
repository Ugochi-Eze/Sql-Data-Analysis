...
/* 1. What is the total revenue geneerated by each product cateory?*/
...
/* 6. What are the 10 highest performing products?*/
SELECT product_name,
       ROUND(SUM(total),2)Revenue
FROM orders
JOIN products
...
/* 7. Show the total revenue and profit generated by each account?*/
...
/* 8. What is the name, cuity, and account of the highest selling product in 2017?*/
SELECT product_name,
       city,
       account_manager,
